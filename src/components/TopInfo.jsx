...
const TopInfo = () => {
  ...
  return (
    <div className="w-full bg-gray-300 flex lg:py-6 md:py-4">
      <h1 className="flex items-center text-xs font-bold text-gray-700 space-x-2">
        {/* Icon with rose background */}
        <span className="flex items-center justify-center bg-rose-400 animate-pulse rounded-full p-1">
          <BsFillGeoAltFill className="text-green-900 animate-bounce text-lg" />
        </span>
        {/* Text */}
        <span className="tracking-wide md:text-lg lg:text-xl">
          Fast Delivery
        </span>
        {user ? (
          <p className="capitalize md:text-lg">
            Hello{" "}
            <span className="capitalize text-lg bg-rose-700 text-green-50 px-2 rounded-sm ">
              {myuser.name}
            </span>
